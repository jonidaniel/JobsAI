"""
Technology and Experience Alias Mappings.

This module contains mapping dictionaries for normalizing technology names
and experience levels between frontend and backend representations.
...
These mappings are used throughout the pipeline for:
    - Normalizing user input from various formats
    - Converting between frontend and backend naming conventions
    - Displaying consistent technology names in generated content
"""
